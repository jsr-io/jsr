...
# Admin API key used to configure the Algolia provider (manages indices and
# derives the scoped write/search keys). The scoped keys the app actually uses
# are generated by Terraform — see algolia.tf.
