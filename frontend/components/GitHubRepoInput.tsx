...
export function GitHubRepoInput(
  ...
  return (
    <div class="flex items-center w-full md:w-88 rounded-md text-jsr-gray-900 dark:text-gray-200 shadow-sm pl-3 py-[2px] pr-[2px] sm:text-sm sm:leading-6 bg-white dark:bg-jsr-gray-800 input-container">
      <span class="block">
      ...
      <input
        ...
        disabled={disabled}
      />
      <span class="block text-jsr-gray-500 dark:text-gray-400">/</span>
      <input
        ref={repoRef}
