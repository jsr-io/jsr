...
export function NavOverflow() {
  return (
    <>
      <button
        type="button"
        class="group absolute right-4 md:right-10 rounded-sm border-1 my-1 border-jsr-cyan-100 dark:border-jsr-cyan-800 hover:bg-jsr-cyan-50 dark:hover:bg-jsr-cyan-700 hover:cursor-pointer hidden"
        aria-expanded="false"
      >
        <span class="flex p-1">
          <TbDots class="size-6" />
        ...
        <div
          id="nav-menu"
          class="absolute top-[120%] -right-2 z-[70] px-1 py-2 rounded-sm border-1.5 border-current dark:border-cyan-700 bg-white dark:bg-jsr-gray-950 w-56 shadow-sm overflow-hidden opacity-100 translate-y-0 transition [&>a]:rounded-sm hidden"
        />
      </button>
      <script
