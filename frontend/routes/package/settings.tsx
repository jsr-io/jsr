      ...
      <div class="mb-20">
        ...
        {data.iam.isStaff && (
          <div class="border-t pt-8 mt-12">
            ...
            <p class="mt-2 text-jsr-gray-600 dark:text-gray-400 max-w-3xl">
...
function GitHubRepository(props: { package: Package }) {
  return (
    <div class="border-t pt-8 mt-12">
      ...
      <p class="mt-2 mb-4 text-jsr-gray-600 dark:text-gray-400 max-w-3xl">
...
function RuntimeCompatEditorItem({ name, id, value }: {
  ...
  return (
    <label class="block text-jsr-gray-600 dark:text-gray-400 font-bold" htmlFor={id}>
      {name}
      <select
  ...
  if (!props.isArchived) {
    return (
      <form class="border-t pt-8 mt-12" method="POST">
        ...
        <p className="mt-2 text-jsr-gray-600 dark:text-gray-400 max-w-3xl">
