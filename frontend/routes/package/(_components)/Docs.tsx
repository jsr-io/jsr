  ...
  return (
    <div class="pt-6 space-y-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        {docs.toc && (
          <div class={`max-lg:row-start-1 lg:col-[span_1_/_-1] lg:top-0 lg:sticky lg:max-h-screen flex flex-col box-border gap-y-4 -mt-4 pt-4 ${docs.breadcrumbs ? "lg:-mt-20 lg:pt-20" : ""}`}>
            {!docs.breadcrumbs && (
              <LocalSymbolSearch
                scope={params.scope}
                pkg={params.package}
